...
@Entity
@Table(name = "payment_selection_filtered_out_providers")
class SelectionFilteredOutProviderJpaEntity(
    @Id
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is SelectionFilteredOutProviderJpaEntity) return false
